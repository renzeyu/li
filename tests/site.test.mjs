...
test("ships one validated schema v2 genealogy graph", async () => {
  ...
  const expectedPortraits = new Map([
    ["li-kaixun-father", "li-yunju"],
    ["li-kaixun", "li-kaixun"],
    ["zhu-shouzhi", "zhu-shouzhi"],
    ["li-ping", "li-ping-v3"],
    ["ren-zeyu", "ren-zeyu-v2"],
    ["ren-dongfeng", "ren-dongfeng-v2"],
    ["wu-fang", "wu-fang-v2"],
    ["xu-lingxi", "xu-lingxi"],
    ["li-kun", "li-kun"],
    ["li-zirong", "li-zirong"],
    ...
    ["xu-dapeng", "xu-dapeng"],
    ["xu-jinghan", "xu-jinghan-v2"],
    ["li-yuxia", "li-yuxia"],
    ["peng-xuejian", "peng-xuejian"],
    ["peng-peng", "peng-peng"],
    ["wu-qinghua", "wu-qinghua"],
    ["peng-peng-spouse", "wang-xinnan"],
    ["peng-peng-daughter", "peng-youting"],
  ]);
...
test("includes every GitHub Pages artifact", async () => {
  await Promise.all(
    [
      ...
      "images/portraits/li-yunju.avif",
      "images/portraits/li-ping-v3.avif",
      "images/portraits/ren-zeyu-v2.avif",
      "images/portraits/ren-dongfeng-v2.avif",
      "images/portraits/wu-fang-v2.avif",
      ...
      "images/portraits/li-hui-v2.avif",
      "images/portraits/li-yuzhen-v2.avif",
      "images/portraits/xu-dapeng.avif",
      "images/portraits/xu-jinghan-v2.avif",
      "images/portraits/li-yuxia.avif",
      "images/portraits/peng-xuejian.avif",
      "images/portraits/peng-peng.avif",
      "images/portraits/wu-qinghua.avif",
      "images/portraits/wang-xinnan.avif",
      "images/portraits/peng-youting.avif",
